...
print(f"The total of all loans in the list: ${sum_of_all_loans}")
...
print(f"The amount of money the borrower has to pay back upon maturity of the loan is ${future_value}")
print(f"The remaining maturity before the loan needs to be fully repaid is {remaining_months} months")
...
print(f"The fair value of loan is ${fair_value_of_loan:.2f}")
...
# Getting the loan price from the loan object
loan_price = loan.get("loan_price")

# Using conditional statement to decide if present value represents the loan's fair value
...
# Defining new function for calculating present value which will return the present value for a loan
...
# Calculating present value of new loan given
...
output_path = Path("Challenge 1- Starter_Code/inexpensive_loans.csv")
